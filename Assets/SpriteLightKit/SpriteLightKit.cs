	...
	public class SpriteLightKit : MonoBehaviour
	{
		...
		void updateTexture( bool forceRefresh = true )
		{
			...
			if( forceRefresh || _texture == null )
			{
                ...
                rtHeight = System.Convert.ToInt32(rtHeight * mainCamera.rect.height);
                rtWidth = System.Convert.ToInt32(rtWidth * mainCamera.rect.width);
